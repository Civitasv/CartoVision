...
<head>
    ...
    <style>
        ...
        .second-work-image {
            ...
            background-image: url("image/ep_naturalwhite.png");
            background-position: center;
            overflow: hidden;
        }
        ...
        .contact-image {
            padding-bottom: 100px;
            background-image: url("image/redox.png");
            background-position: center;
            overflow: hidden;
        }
        ...
        .rights-image{
            background-image: url("image/dark_wall.png");
            background-position: center;
            overflow: hidden;
            color:whitesmoke;
        }
    ...
    <script>
        $(document).ready(function () {
            ...
            function myChart(id, name, value) {
    ...
    <link rel="stylesheet" type="text/css" href="${path}/quote_css/buttons.css"/>
</head>
<body>
        ...
        <div class="first-work">
            ...
            <div class="row work-image">
                ...
                <div class="Wrapper Wrapper_flex_center" style="margin-top: 60px;">
                    <div class="TemplateLgallery" data-lgallery="image/map.png" data-lglabel="平面图" data-lghover="300">
                        <div class="TemplateLgallery-Item">
                            <img src="image/map.png" alt="Witcher"/>
                        </div>
                    </div>

                    <div class="TemplateLgallery" data-lghover="300"
                         data-lgallery="image/map2.png"
                         data-lglabel="卫星图" data-lgdescription="">
                        <div class="TemplateLgallery-Item">
                            <img src="image/map2.png" alt="Witcher"/>
                        </div>
                    </div>

                    <div class="TemplateLgallery" data-lghover="300"
                         data-lgallery="image/map3.png"
                         data-lglabel="全景图" data-lgdescription="使用无人机对武大进行了景点的采集">
                        <div class="TemplateLgallery-Item">
                            <img src="image/map3.png" alt="Witcher"/>
                        </div>
                    </div>
                </div>
            </div>
